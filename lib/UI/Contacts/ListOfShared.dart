...
class ListOfShared extends StatefulWidget {
  final category_name;

  ListOfShared(this.category_name);

  @override
  _ListOfSharedState createState() => _ListOfSharedState();
}

class _ListOfSharedState extends State<ListOfShared> {
  ...
  Future getFilterShared() async {
    if (widget.category_name == "All") {
      ...
      Provider.of<CustomViewModel>(context, listen: false)
          .getFilterShared(widget.category_name, "")
          .then((value) {
        setState(() {
          if (value == "success") {
            setState(() {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
                      ...
                      children: [
                        Row(
                          children: [
                            ...
                            commonTitle(context, widget.category_name),
                          ],
                        ),
                        InkWell(
                          onTap: () {
      ...
      body: Container(
        ...
        child: providerListener.FilterSharedList.length > 0
            ? ListView.builder(
                itemCount: providerListener.FilterSharedList.length,
                              ...
                              children: <Widget>[
                                ...
                                Padding(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      providerListener.FilterSharedList[index]
                                                      .companyFQ !=
                                                  "" &&
                                              providerListener
                                                      .FilterSharedList[index]
                                ...
                                providerListener.FilterSharedList[index].tags !=
                                        ""
                                    ? providerListener
                                                .FilterSharedList[index].tags !=
                                            null
                                ...
                                providerListener.FilterSharedList[index].userId !=
                                        "0"
                                    ? InkWell(
                                        onTap: () {
                                          _launchURL((apiUrl +
